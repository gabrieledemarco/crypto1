# Strategy Report: Stat-Derived Trend Following — BTC-USD
*Source: stats_derived (Hurst=0.5916, regime=trend_following)*

**Type**: trend_following
**SL**: 2.5×ATR | **TP**: 6.5×ATR | **R:R**: 2.6:1 | **Active hours**: [5, 11] UTC

**Rationale**: Hurst=0.5916>0.55 → momentum/trending regime; ACF(1)=0.0319 (momentum); kurtosis=8.95→SL=2.5×ATR; active_hours=[5, 11] from best UTC hours [6, 7, 9, 10].
